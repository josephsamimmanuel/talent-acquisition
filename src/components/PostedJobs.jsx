          ...
          <div className='post1-container-contents'>
            ...
            <div className="post1-container-AppInfo">
              <div className="post1-container-AppInfo-title">
                <FaPython style={{ fontSize: '1.5em' }} />
                <p style={{ paddingTop: "15px", fontWeight: "bold" }}>Python Developers</p>
                <HiDotsVertical />
              </div>
              <hr />
              <div className="post1-container-AppInfo-body">
                ...
                <p style={{ paddingTop: "15px" }}>Total Applicants</p>
              </div>
              <hr />
            ...
            <div className="post1-container-AppInfo">
              <div className="post1-container-AppInfo-title">
                <FaAngular style={{ fontSize: '1.5em' }} />
                <p style={{ paddingTop: "15px", fontWeight: "bold" }}>Angular Developers</p>
                <HiDotsVertical />
              </div>
              <hr />
              <div className="post1-container-AppInfo-body">
            ...
            <div className="post1-container-AppInfo">
              <div className="post1-container-AppInfo-title">
                <FaJava style={{ fontSize: '1.5em' }} />
                <p style={{ paddingTop: "15px", fontWeight: "bold" }}>Java Developers</p>
                <HiDotsVertical />
              </div>
              <hr />
              <div className="post1-container-AppInfo-body">
            ...
            <div className="post1-container-AppInfo">
              <div className="post1-container-AppInfo-title">
                ...
                <p style={{ paddingTop: "15px", fontWeight: "bold" }}>UI | UX Designer</p>
                <HiDotsVertical />
              </div>
              <hr />
              <div className="post1-container-AppInfo-body">
